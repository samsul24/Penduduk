    ...
    <div class="content">
      ...
      <i class="nav-icon fas fa-home"></i> Dashboard &nbsp; &nbsp; > &nbsp;  &nbsp;<i class="nav-icon fas fa-tablet"></i> Penduduk&nbsp; > <i class="nav-icon fas fa-plus"></i>tambah kategori
                ...
                <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="no_kk" placeholder="No KK" name="no_kk" required>
                        </div>
                        <div class="form-group">
                            <label for="nama_keluarga">Nama Keluarga :</label>
                            <input type="text" class="form-control" id="nama_keluarga" placeholder="Nama Keluarga" name="nama_keluarga" required>
                        </div>
                        <div class="form-group">
